...
&bt BT_CLR_ALL,    &bt BT_SEL 0,      &bt BT_SEL 1,      &bt BT_SEL 2,      &bt BT_SEL 4,      &kp LC(Y),         &kp LC(V),         &kp LC(C),         &kp LC(X),         &kp LC(Z),             \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp LC(Y),         &kp LC(V),         &kp LC(C),         &kp LC(X),         &kp LC(Z),             \
...
&kp LS(NUHS),      &kp EXCL,          &kp AT,            &kp NUHS,          &kp LS(NUBS),      U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
